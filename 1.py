...
class Empleado(Persona):
    ...
    # declaramos el metodo del descuento del sueldo
    # si el sueldo es mayor a 3600000 se descontara 3,5 del sueldo 

    def desc_Sueldo(self):
        if self.sueldo > 3600000:
            desc = (self.sueldo * 3.5) / 100
            sueldo_desc = self.sueldo - desc
            print("Se descuenta de su sueldo una cantidad de: ", desc)
            print(" Su sueldo es de: ", sueldo_desc)
        else:
